...
def download_video():
    ...
    while True:
        ...
        if event==sg.WIN_CLOSED or event=='Cancel':
            ...
            print(nm)
            # get_details_window['-VIDEO_NAME-'].update(f'Your video is "{nm1}"\n',font=helv)
            # sg.popup_ok_cancel(f'Your video is "{nm1}"\n',font=helv)
            # while True:
            ...
            event, values = sg.Window('Wanna Download This?',
                            ...
                            [sg.T()],
                            [sg.T(),sg.B('Download',font=helv),sg.T(),sg.B('Download and open Video',font=helv),sg.T(),
            ...
            if event=='Download':
                ...
                break
            elif event=='Download and open Video':
